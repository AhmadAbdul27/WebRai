                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-right">
                        <ul id="mainmenu" class="nav navbar-nav nav-menu">
                            ...
                            <li class="active"><a href="{{route('cabang1')}}"style="font-size: 14px;">Cabang</a></li>
                            <li><a href="{{route('makanan_frontend')}}" style="font-size: 14px;">Menu</a></li>
        ...
        <section id="news" class="blog_section bd-bottom padding">
            <div class="container">
                ...
                <div class="col-sm-4 col-xs-6 xs-padding">
                    <div class="blog_post">
                        <img src="{{asset('assets/hangout/img/'. $data->foto) }}" alt="blog-image" style="max-height:350px; max-width: 350px; margin-top: 6px;">
